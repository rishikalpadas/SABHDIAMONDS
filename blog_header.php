                        ...
                        <nav class="navbar navbar-expand-lg">
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <div class="navbar-nav ml-auto d-flex align-items-center">
                                    ...
                                    <a class="nav-link link" href="index.php#about">About Coffee</a>
                                    <a class="nav-link link" href="index.php#menu">Our Menu</a>
                                    <a class="nav-link link" href="index.php#reviews">Reviews</a>
                                    <a class="nav-link link active" href="index.php#blog">News & Blog</a>
                    ...
                    <div class="col-12 col-lg-8 text-center text-lg-left">
                        <nav class="side-nav w-100">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="index.php#about">About Coffee</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="index.php#menu">Our Menu</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="index.php#reviews">Reviews</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="index.php#blog">News & Blog</a>
                                </li>
